"""
This module contains the forms for the whizzer model.
"""
...
class WhizzerSignUpEmailForm(BaseFormMixin, forms.ModelForm):
    """
    This is the sign up form for the email details of a whizzer.
    """
...
class WhizzerSignUpPersonalDetailForm(BaseFormMixin, forms.ModelForm):
    """
    This is the sign up form for the personal details of a whizzer.
    """
...
class WhizzerSignUpPasswordForm(BaseFormMixin, UserCreationForm):
    """
       This is the sign up form for the password details of a whizzer.
    """
